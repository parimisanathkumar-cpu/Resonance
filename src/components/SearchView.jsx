    ...
    const fetchResults = async () => {
      ...
      try {
        ...
        if (
          ...
          const isSpecific =
            /live|cover|karaoke|instrumental|audio|official/i.test(globalQuery);
          ...
          if (activeCategory === "All" || activeCategory === "Songs") {
            ...
            const isUserQuerySpecific =
              /live|cover|karaoke|instrumental|remix|acoustic/i.test(
                globalQuery,
              );
            ...
            rawSongs.sort((a, b) => {
              ...
              return (
                scoreTrack(b.title, b.artist) - scoreTrack(a.title, a.artist)
              );
            });
        ...
        if (
          ...
          const uniqueChannelIds = [
            ...new Set(
              songItems.slice(0, 12).map((item) => item.snippet.channelId),
            ),
          ].slice(0, 6);

          if (uniqueChannelIds.length > 0) {
            const channelRes = await fetch(
              `https://youtube.googleapis.com/youtube/v3/channels?part=snippet&id=${uniqueChannelIds.join(",")}&key=${apiKey}`,
            );
  ...
  return (
    ...
    >
      ...
      {songResults.length > 0 ? (
          ...
          >
            ...
            <div
              ...
              onMouseLeave={(e) => {
                ...
                e.currentTarget.querySelector(
                  ".play-btn-circle",
                ).style.opacity = isTopActive ? "1" : "0";
                e.currentTarget.querySelector(
                  ".play-btn-circle",
                ).style.transform = isTopActive
                  ? "translateY(0)"
                  : "translateY(8px)";
              }}
              style={{
            ...
            >
                  ...
                  <span
                    onClick={(e) => {
                      ...
                      if (songResults[0].artistId) {
                        onNavigate("artist", {
                          id: songResults[0].artistId,
                          title: songResults[0].artist,
                          coverArt: songResults[0].coverArt,
                        });
                      }
                    }}
                    style={{
                      fontSize: "14px",
                      color: "var(--text-main)",
                      cursor: songResults[0].artistId ? "pointer" : "default",
                    }}
                    onMouseOver={(e) =>
                      songResults[0].artistId &&
              ...
              <div
                ...
                style={{
                  ...
                  transform:
                    currentTrack?.id === songResults[0].id
                      ? "translateY(0)"
                      : "translateY(8px)",
                  ...
                  >
                    ...
                    >
                      <span
                        ...
                        style={{
                          fontSize: "15px",
                          fontWeight: isThisTrackActive ? "600" : "500",
        ...
        activeCategory === "Songs" &&
        !isSearching && (
          <div style={{ color: "var(--text-muted)" }}>No songs found</div>
        )
      )}
              ...
              return (
                <div
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.querySelector(
                      ".play-btn-circle",
                    ).style.opacity = isThisTrackActive ? "1" : "0";
                    e.currentTarget.querySelector(
                      ".play-btn-circle",
                    ).style.transform = isThisTrackActive
                      ? "translateY(0)"
                      : "translateY(8px)";
                  }}
                >
